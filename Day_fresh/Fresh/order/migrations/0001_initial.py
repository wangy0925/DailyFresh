# Generated by Django 2.2.3 on 2019-07-09 02:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transit_price', models.DecimalField(decimal_places=2, max_digits=18, verbose_name='商品运费')),
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待发货'), (3, '待收货'), (4, '待评价'), (5, '已完成')], verbose_name='订单支付状态')),
